...
func init() {
	...
	message.SetString(language.English, "域名 %s 解析未找到且因添加了参数 %s=%s 导致无法创建，本次更新已被忽略", "The domain %s was not found and could not be created because the parameter recordset_id=%s was added, this update was ignored")
